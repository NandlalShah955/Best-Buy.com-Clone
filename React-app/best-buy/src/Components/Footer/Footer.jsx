            ...
            <div className={styles.icon}>
              ...
              >
                <svg
                  ...
                  xmlSpace="preserve"
                >
                  <path d="M16.04.73C7.64.73.8 7.57.8 15.97s6.84 15.25 15.24 15.25c8.41 0 15.25-6.84 15.25-15.25 0-8.4-6.84-15.24-15.25-15.24zm0 28.53a13.3 13.3 0 0 1 0-26.58 13.3 13.3 0 0 1 0 26.58zm1.41-5.38a1.45 1.45 0 1 1-2.9 0 1.45 1.45 0 0 1 2.9 0zm3.73-12.56c0 2.3-1.47 3.5-2.65 4.48-.94.77-1.5 1.28-1.5 1.98v1.96a.98.98 0 0 1-1.96 0v-1.96c0-1.66 1.17-2.63 2.21-3.49 1.05-.86 1.95-1.6 1.95-2.97 0-.03-.04-3.05-3.19-3.05-3.06 0-3.38 3.1-3.4 3.24a.98.98 0 1 1-1.95-.18c.17-1.74 1.5-5.02 5.35-5.02 3.77 0 5.14 3 5.14 5z"></path>
                </svg>
              </svg>
            </div>
            ...
            <div className={styles.icon}>
              ...
              >
                ...
                >
                  ...
                  <path d="M8.98 13.44a.98.98 0 0 0-.98-.97l-7.02.01a.98.98 0 0 0 0 1.96L8 14.42c.54 0 .98-.44.98-.98zM4 11.15h4a.98.98 0 0 0 0-1.96H4a.98.98 0 0 0 0 1.96z"></path>
                </svg>
              </svg>
            </div>
            <div className={styles.i_title}>
            ...
            <div className={styles.icon}>
              ...
              >
                ...
                >
                  ...
                  <path d="M24.36 8.59H7.84a.98.98 0 0 0-.97.98V22.1c0 .54.43.97.97.97h16.52c.54 0 .98-.43.98-.97V9.57a.98.98 0 0 0-.98-.98zm-.98 12.53H8.82V10.54h14.56v10.58z"></path>
                  <path d="m31.16 4.57-2.95-2.95A.98.98 0 1 0 26.83 3l1.28 1.28H11.94a.98.98 0 0 0 0 1.95H28.1l-1.28 1.29A.98.98 0 0 0 28.2 8.9l2.95-2.95a.98.98 0 0 0 0-1.38zM18.48 25.4H3.93l1.28-1.28a.98.98 0 1 0-1.38-1.38L.88 25.69a.98.98 0 0 0 0 1.38l2.95 2.95a.97.97 0 0 0 1.38 0c.39-.38.39-1 0-1.38l-1.28-1.29h14.55a.98.98 0 1 0 0-1.95z"></path>
                </svg>
              </svg>
            </div>
            <div className={styles.i_title}>
        ...
        <div className={styles.navigation_links}>
          <div className={styles.left}>
            ...
            <div className={styles.list}>
              ...
              <div className={styles.links}>
                <ul>
                  ...
                  <li>Shop with an Expert</li>
                  <li>Schedule a Service</li>
                  <li>Manage an Appointment</li>
                  <li>Protection & Support Plans</li>
                  <li>Haul Away & Recycling</li>
                  <li>Contact Us</li>
                </ul>
              </div>
            </div>
            ...
            <div className={styles.list}>
              ...
              <div className={styles.links}>
                <ul>
                  <li>My Best Buy® Credit Card</li>
                  <li>Pay Your Bill at Citibank</li>
                  <li>Lease to Own</li>
                </ul>
              </div>
            </div>
            <div className={styles.list}>
              ...
              <div className={styles.links}>
                <ul>
                  <li>Best Buy Totaltech</li>
                  <li>My Best Buy</li>
                  <li>View Points & Certificates</li>
                  <li>Member Offers</li>
                </ul>
              </div>
            </div>
            <div className={styles.list}>
              ...
              <div className={styles.links}>
                <ul>
                  ...
                  <li>Careers</li>
                  <li>Corporate Responsibility & Sustainability</li>
          ...
          <div className={styles.right}>
            ...
            <div className={styles.app_section}>
              ...
              <div className={styles.a_buy}>
                <p className={styles.a_buy_t}>Best Buy app</p>
                <p className={styles.a_small}>Learn More &gt;</p>
              </div>
            </div>
            <div className={styles.border}></div>
              ...
              <div className={styles.s_icon}>
                ...
                >
                  <svg
                    ...
                    xmlSpace="preserve"
                  >
                    <path d="M17.3 10.9c0-.7.5-.9.8-.9h2V6.9h-2.7c-3 0-3.7 2.3-3.7 3.8v2.1H12V16h1.7v9.1h3.6V16h2.5l.3-3.2h-2.8v-1.9z"></path>
                    <path d="M31.2 16a15.2 15.2 0 1 1-30.39.01A15.2 15.2 0 0 1 31.2 16zm-1.9 0c0-7.3-6-13.3-13.3-13.3S2.7 8.7 2.7 16s6 13.3 13.3 13.3 13.3-6 13.3-13.3z"></path>
                  </svg>
                </svg>
              </div>
              <div className={styles.s_icon}>
