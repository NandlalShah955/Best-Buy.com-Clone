  ...
  return (
    <>
      ...
      <div className={styles.home_e2}>
        <img src={require("./Longimage.jpeg")} alt="" />
      </div>
      ...
      <div className={styles.home_dealsinpired}>
        ...
        <div>
          <img
            src="https://pisces.bbystatic.com/image2/BestBuy_US/images/products/6449/6449413_sd.jpg;maxHeight=272;maxWidth=400"
            alt=""
          />
        ...
        <div>
          <img
            src="https://pisces.bbystatic.com/image2/BestBuy_US/images/products/6461/6461530_sd.jpg;maxHeight=272;maxWidth=400"
            alt=""
          />
          <p>
        ...
        <div>
          <img
            src="https://pisces.bbystatic.com/image2/BestBuy_US/images/products/6477/6477102_sd.jpg;maxHeight=150;maxWidth=225"
            alt=""
          />
      ...
      {/* curousel item to be placed below this thing  */}

      <div className={styles.growcarrier}>
        <div className={styles.carrerstartimage}>
          <h1 className={styles.headinghai}>Apple Top Deals.</h1>
          <h4 className={styles.para}>Shop all Apple Top Deals</h4>
          <div className={styles.imagehaicarrerwala}>
            <img src={require("./Slider-image.jpg")} alt="" />
          </div>
        </div>

        {/* <Slider {...settings}></Slider> */}
       
        <div className={styles.carrerslider}>
         
         
          <div className={styles.rokaucareerwala}>
            <div className={styles.prodimage}>
              <img
                src="https://pisces.bbystatic.com/image2/BestBuy_US/images/products/4901/4901809_sd.jpg;maxHeight=240;maxWidth=240"
                alt=""
              />
            </div>
            ...
            <div className={styles.stars}>
              <img src={require("./Stars.jpeg")} alt="" />
              <p>(6628)</p>
            </div>
            <h4>$329.99</h4>
          </div>
          ...
          <div className={styles.rokaucareerwala}>
            <div className={styles.prodimage}>
              <img
                src="https://pisces.bbystatic.com/image2/BestBuy_US/images/products/4901/4901811_sd.jpg;maxHeight=240;maxWidth=240"
                alt=""
              />
            </div>

            <p>
              Apple - 10.2-Inch iPad (Latest Model) with Wi-Fi - 64GB - Silver
            </p>
            <div className={styles.stars}>
              <img src={require("./Stars.jpeg")} alt="" />
              <p>(6628)</p>
          ...
          <div className={styles.rokaucareerwala}>
            <div className={styles.laptopimage}>
              <img
                src="https://pisces.bbystatic.com/image2/BestBuy_US/images/products/6418/6418601_sd.jpg;maxHeight=240;maxWidth=240"
                alt=""
              />
            </div>

            <p>MacBook Pro 13.3" Laptop - Apple M1 chip - 8GB Memory - 256G</p>
            <div className={styles.stars}>
              <img src={require("./Stars.jpeg")} alt="" />
              <p>(6628)</p>
            </div>
          ...
          <div className={styles.rokaucareerwala}>
            <div className={styles.laptopimage}>
              <img
                src="https://pisces.bbystatic.com/image2/BestBuy_US/images/products/6450/6450853_sd.jpg;maxHeight=240;maxWidth=240"
                alt=""
              />
            </div>

            <p>
              MacBook Pro 14" Laptop - Apple M1 Pro chip - 16GB Memory - 512GB
            </p>
            <div className={styles.stars}>
              <img src={require("./Stars.jpeg")} alt="" />
              <p>(1696)</p>
          ...
          <div className={styles.rokaucareerwala}>
            <div className={styles.laptopimage}>
              <img
                src="https://pisces.bbystatic.com/image2/BestBuy_US/images/products/6509/6509650_sd.jpg;maxHeight=240;maxWidth=240"
                alt=""
              />
            </div>

            <p>
              MacBook Air 13.6" Laptop - Apple M2 chip - 8GB Memory - 256G..
            </p>
            <div className={styles.stars}>
              <img src={require("./Stars.jpeg")} alt="" />
              <p>(6628)</p>
          ...
          {/* more boxes to be done here  */}

          <div className={styles.rokaucareerwala}>
            <div className={styles.prodimage}>
              <img
                src="https://pisces.bbystatic.com/image2/BestBuy_US/images/products/6342/6342362_sd.jpg;maxHeight=240;maxWidth=240"
                alt=""
              />
            </div>
   ...
   slidesToScroll: 3
      ...
      <div className={styles.home_dealsinpired}>
        <div>
          ...
          />
          <p>
            Samsung - 55" Odyssey Ark 4K UHD 165Hz 1ms Quantum Mini-LED
            Multiview Curved...
          </p>
          <h4>$3499.99</h4>
        </div>
        <div>
          ...
          />
          <p>
            Samsung - Galaxy Book2 Pro 13.3" AMOLED Laptop - Intel 12th Gen Core
            i5 Evo...
          </p>
          <h4>$1099.99</h4>
        </div>
        <div>
          ...
          />
          <p>
            Arlo - Essential Spotlight 4 Cameras and Yard Sign, Indoor/Outdoor,
            Wireless,...
          </p>
          <h4>$349.99</h4>
          <p>$449.99</p>
        ...
        <div>
          ...
          />
          <p>
            HP - Spectre x360 2-in-1 13.5" 3K2K Touch-Screen Laptop - Intel Evo
            Core i7{" "}
          </p>
          <h4>$1749.99</h4>
        </div>
        <div>
          ...
          />
          <p>
            Ring - Floodlight Cam Wired Pro Outdoor Wireless 1080p Surveillance
            Camera - Black
          </p>
          <h4>$249.99</h4>
        </div>
        <div>
          ...
          />
          <p>
            Dell - Inspiron 2-in-1 16” FHD+ Touch Laptop – 12th Gen Intel Evo i7
            – 16GB..
          </p>
          <h4>$1199.99</h4>
          <p>1349.99</p>
